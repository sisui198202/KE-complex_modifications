...
---
## functionkey_summary.json.erb:F1_よく使う-md,F2_Rename

{
    "description": "F1_よく使う-md",
    "type": "basic",
    "from": <%= from("f1") %>,
    "to": <%= set_shell_command(["open '/Users/user/Desktop/test.md'"]) %>,
    "conditions": [ <%= frontmost_application_unless("virtual_machine") %>]
},
{
...
---
## double_push_key.json.erb Double LeftShift_Ctrl + C(Vscode-iterm2:Double Push)
...
---
## replacekey_summary.json.erb_RightCommand日本語モード(Replacekey)
...
---
## functionkey_summary.json.erb

{
  "description": "Double F12 -> CaptureWindow-Cmd+Opt+Control+quote",
  "type": "basic",
  "from": { "key_code": "f12" },
  "to": [
    { "set_variable": { "name": "f12_pressed", "value": 0 } },
    { "key_code": "quote", "modifiers": ["command", "option", "control"] }
  ],
  "conditions": [
    { "type": "variable_if", "name": "f12_pressed", "value": 1 }
  ]
},
{
  "description": "Single F12 -> CaptureArea-Cmd+Ctrl+Opt+semicolon",
  "type": "basic",
  "from": { "key_code": "f12" },
  "to": [
    { "set_variable": { "name": "f12_pressed", "value": 1 } }
  ],
  "to_delayed_action": {
    "to_if_invoked": [
      {
  ...
  "conditions": [
    { "type": "variable_if", "name": "f12_pressed", "value": 0 }
  ]
}
