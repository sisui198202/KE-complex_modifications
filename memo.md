...
---------------------
## Heper Switchが起動できていた時の設定

{
  "description": "LeftCommand + comma_AppsIn-Next",
  "type": "basic",
  "from": <%= from("comma", ["left_control"], ["caps_lock"]) %>,
  "to": <%= to([["tab", "right_gui"]]) %>
},
{
  "description": "LeftCommand + Period_AppsSelect-Next",
  "type": "basic",
  "from": <%= from("period", ["left_control"], ["caps_lock"]) %>,
  "to": <%= to([["tab", "right_option"]]) %>
},
