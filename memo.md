...
![独自ルールGitHubPages接続方法1](./images/独自ルールGitHubPages接続方法1.png)

3. Settings

![独自ルールGitHubPages接続方法2](./images/独自ルールGitHubPages接続方法2.png)

4. Visit site

![独自ルールGitHubPages接続方法3](./images/独自ルールGitHubPages接続方法3.png)
